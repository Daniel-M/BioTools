...
/*! This typedef creates the type function_t, a pointer to a function of the form 
 * double function(const point_t&)
 * This function is used to create the initial condition for the mesh using a given function.*/
typedef floating_t (*function_t)( const point_t& ); /*!< A Pointer to initial condition functions. */
